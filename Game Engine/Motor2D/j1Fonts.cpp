...
SDL_Texture* j1Fonts::Print(const char* text, uint wrap_width, SDL_Color color, TTF_Font* font)
{
	SDL_Texture* ret = NULL;
	SDL_Surface* surface = TTF_RenderText_Blended_Wrapped((font) ? font : default, text, color, (wrap_width > 0) ? wrap_width : App->render->camera.w);
...
int j1Fonts::CalcHeight(_TTF_Font* font) const
{
